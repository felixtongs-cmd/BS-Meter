...
export default function LoginPage() {
  ...
  async function handleResend() {
    ...
    setMessage({
      type: "success",
      text: "If this email exists and is unverified, a new confirmation link has been sent.",
    });
  }
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-2 text-sm mt-2 rounded-lg border border-slate-600 text-slate-300 hover:border-slate-500 hover:bg-slate-800/60 disabled:opacity-50 transition-colors"
          >
            {resendLoading ? "Resending confirmation…" : "Resend verification email"}
          </button>
        </form>
